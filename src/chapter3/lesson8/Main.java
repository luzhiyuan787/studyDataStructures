...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("chapter3.lesson9.MergeSort", arr1);
        SortTestHelper.testSort("chapter3.lesson9.QuickSort2Ways", arr2);
        SortTestHelper.testSort("chapter3.lesson9.QuickSort3Ways", arr3);
